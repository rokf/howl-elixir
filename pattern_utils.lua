...
local scope_changers = P {
  ...
  import = P'import' * V'ws' * Ct(Cg(Cc'import','tag') * (((Cg(V'name',"root_name") * P'.' * Cg(V'wn','wrapped')) + Cg(V'name','root_name')))),
  alias = P'alias' * V'ws' * Ct(Cg(Cc'alias','tag') * (((Cg(V'name',"root_name") * P'.' * Cg(V'wn','wrapped')) + Cg(V'name','root_name'))) * Cg(V'as','as')^-1),
